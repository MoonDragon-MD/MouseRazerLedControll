...
class Device:
    ...
    def load_macro(self, macro_id, dump):
        ...
        _ = dump.get('macro_info')
        if _:
            self.set_macro_info(macro_id, _)
        _ = dump.get('macro_function')
        if _:
